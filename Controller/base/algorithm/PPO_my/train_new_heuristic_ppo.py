...
class LightweightHeuristicPPOTrainer:
    ...
    def __init__(self, 
        ...
        # 创建环境和agent
        self.env = NewHeuristicEnvironment(**self.env_config)
        ...
        self.experiment_name = f"new_heuristic_{self.experiment_timestamp}"
    ...
    def _save_experiment_config(self):
        ...
        experiment_info = {
            ...
            'algorithm_type': 'new_heuristic_ppo',  # 标识算法类型
            'env_config': self.env_config,
            'agent_config': self.agent_config,
            'training_config': self.training_config
        }
