...
class OriginalSequentialPPOTrainer:
    ...
    def __init__(self, 
        ...
        # 创建环境和agent
        self.env = SequentialNetworkSchedulerEnvironment(**self.env_config, curriculum_enabled = True)
        ...
        self.experiment_name = f"exp_{self.experiment_timestamp}"
    ...
    def plot_training_curves(self):
        ...
        fig.suptitle(f'Sequential PPO Training Progress - {self.experiment_name}', fontsize=16)
