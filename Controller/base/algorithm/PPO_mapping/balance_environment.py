...
class PPOBalanceNetworkEnvironment:
    """
    PPO_balance网络调度环境
    ...
    def __init__(self, 
                 ...
                 # 其他兼容性参数
                 max_task_nodes: int = None,  # 兼容性参数，用于与测试脚本兼容
                 curriculum_enabled: bool = False,  # 兼容性参数，PPO_balance不使用课程学习
                 seed: int = None,
        ...
        if max_task_nodes is not None:
            ...
            min_tasks, max_tasks = task_nodes_range
        ...
        if seed is not None:
            ...
            print(f"🌱 PPO_balance环境设置随机种子: {seed}")
    ...
    def _set_random_seed(self, seed: int):
        ...
        print(f"🔒 PPO_balance环境随机种子设置完成: {seed}")
