...
if __name__ == '__main__':
	...
	# emu1 = controller.add_emulator ('emulator-1', '100.68.2.3', cpu=128, ram=256, unit='G')
	emu2 = controller.add_emulator ('emulator-2', '100.68.2.1', cpu=128, ram=256, unit='G')
	...
	# controller.add_emulator_bw('emulator-3', 'emulator-2', bw=1000)
